...
export type DateTimeInput = InputObject | Date | string | number | Array<string | number> | DateTime | null | undefined;
export type FormatInput = string | undefined;
export type BaseUnit = 'year' | 'years' | 'y' | 'month' | 'months' | 'M' | 'day' | 'days' | 'd' | 'hour' | 'hours' | 'h' | 'minute' | 'minutes' | 'm' | 'second' | 'seconds' | 's' | 'millisecond' | 'milliseconds' | 'ms';
export type QuarterUnit = 'quarter' | 'quarters' | 'Q';
export type WeekUnit = 'week' | 'weeks' | 'w';
type IsoWeekUnit = 'isoWeek' | 'isoWeeks';
type DateUnit = 'date' | 'dates' | 'D';
export type StartOfUnit = BaseUnit | QuarterUnit | WeekUnit | IsoWeekUnit | DateUnit;
export type AllUnit = BaseUnit | QuarterUnit | DateUnit | WeekUnit | IsoWeekUnit | 'weekday' | 'weekdays' | 'e' | 'isoWeekday' | 'isoWeekdays' | 'E' | 'dayOfYear' | 'dayOfYears' | 'DDD' | 'weekYear' | 'isoWeekYear';
