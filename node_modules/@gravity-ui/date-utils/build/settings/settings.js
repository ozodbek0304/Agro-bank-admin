...
var Settings = /** @class */ (function () {
    function Settings() {
        ...
        this.parser = { parse: datemath_1.parse, isLikeRelative: datemath_1.isLikeRelative };
        this.updateLocale({
    ...
    Settings.prototype.loadLocale = function (locale) {
        return __awaiter(this, void 0, void 0, function () {
            var localeInLowerCase, localeLoader, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        localeLoader = locales_1.localeLoaders[localeInLowerCase];
                        return [4 /*yield*/, localeLoader()];
                    case 2:
                        _a.sent();
    ...
    Settings.prototype.setDefaultTimeZone = function (zone) {
        this.defaultTimeZone = (0, timeZone_1.normalizeTimeZone)(zone, 'system');
    };
    Settings.prototype.getDefaultTimeZone = function () {
        return this.defaultTimeZone;
    };
    Settings.prototype.setRelativeParser = function (parser) {
        this.parser = parser;
    };
    Settings.prototype.getRelativeParser = function () {
        return this.parser;
    };
