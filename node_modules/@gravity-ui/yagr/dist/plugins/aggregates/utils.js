...
exports.safeSum = exports.safeMax = exports.safeMin = exports.getLast = exports.countNumbers = exports.integrate = void 0;
...
const safeMin = (values, from = 0, to = values.length - 1) => {
    if (values.length === 0) {
        return null;
    }
    let min = null;
...
const safeMax = (values, from = 0, to = values.length - 1) => {
    if (values.length === 0) {
        return null;
    }
    let max = null;
...
const safeSum = (values, from = 0, to = values.length - 1) => {
    if (values.length === 0) {
        return null;
    }
    let sum = null;
