...
export const Text = React.forwardRef((_a, ref) => {
    var { as, children, variant, className, ellipsis, color, whiteSpace, wordBreak, qa } = _a, rest = __rest(_a, ["as", "children", "variant", "className", "ellipsis", "color", "whiteSpace", "wordBreak", "qa"]);
    const Tag = as || 'span';
    return (React.createElement(Tag, Object.assign({ ref: ref, className: text({ variant, ellipsis, whiteSpace, wordBreak }, color ? colorText({ color }, className) : className), "data-qa": qa }, rest), children));
});
