...
export const UserAvatar = React.forwardRef(({ imgUrl, fallbackImgUrl, size = 'm', srcSet, sizes, title, className, loading, onClick, qa }, ref) => {
    ...
    React.createElement("div", { className: b({ size }, className), title: title, onClick: onClick, ref: ref, "data-qa": qa },
