...
.yc-popup .g-select-list:first-child, .yc-popup .g-select-list:last-child {
  border-radius: 0;
}
...
.g-select-list__item.yc-list__item_selected {
  background: none;
}
.g-select-list__item.yc-list__item_selected:hover {
  background: var(--g-color-base-simple-hover);
}
.g-select-list__item.yc-list__item_active {
  background: var(--g-color-base-simple-hover);
}
