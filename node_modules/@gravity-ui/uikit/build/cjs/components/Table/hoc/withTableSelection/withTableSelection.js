    ...
    return _a = class extends react_1.default.Component {
            constructor() {
                ...
                this.renderBodyCell = (item, index) => {
                    ...
                    const rowId = Table_1.Table.getRowId(this.props, item, index);
                ...
                this.isDisabled = (item, index) => {
                    ...
                    return (((_a = getRowDescriptor === null || getRowDescriptor === void 0 ? void 0 : getRowDescriptor(item, index)) === null || _a === void 0 ? void 0 : _a.disabled) || (isRowDisabled === null || isRowDisabled === void 0 ? void 0 : isRowDisabled(item, index)) || false);
                };
            }
            render() {
                ...
                columns, onRowClick, getRowDescriptor } = _a, restTableProps = tslib_1.__rest(_a, ["selectedIds", "onSelectionChange", "columns", "onRowClick", "getRowDescriptor"]);
