...
exports.Text = react_1.default.forwardRef((_a, ref) => {
    var { as, children, variant, className, ellipsis, color, whiteSpace, wordBreak, qa } = _a, rest = tslib_1.__rest(_a, ["as", "children", "variant", "className", "ellipsis", "color", "whiteSpace", "wordBreak", "qa"]);
    const Tag = as || 'span';
    return (react_1.default.createElement(Tag, Object.assign({ ref: ref, className: (0, text_1.text)({ variant, ellipsis, whiteSpace, wordBreak }, color ? (0, colorText_1.colorText)({ color }, className) : className), "data-qa": qa }, rest), children));
});
