...
export declare const TextInput: React.ForwardRefExoticComponent<import("../..").DOMProps & import("../..").QAProps & {
    ...
    error?: string | boolean | undefined; /** User`s node rendered before label and input node */
    errorMessage?: React.ReactNode; /** User`s node rendered after input node and clear button */
