...
export declare const Sheet: ({ children, onClose, visible, id, title, className, contentClassName, swipeAreaClassName, allowHideOnContentScroll, hideTopBar, qa, }: SheetProps) => React.JSX.Element | null;
